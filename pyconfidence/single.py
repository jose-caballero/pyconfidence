...
class SingleSectionConfig(object):
    ...
    def __init__(self, section='singlesection'):
        self.conf = pyconfidence.config.Config()
        self.section = section
        self.conf.add_section(self.section)

    def readfp(self, fp, filename=None):
        self.conf.remove_section(self.section)
    ...
    def getdict(self):
        '''
        converts the section into a dictionary
        '''
        return self.conf.getdict(self.section)
